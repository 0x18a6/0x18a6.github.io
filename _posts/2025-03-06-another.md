...
It's worth mentioning these are 1271 signatures. 1271 signatures basically allow smart contracts to sign txs too, based on some pre conditions. This was only a privelege for EOAs pre 1271. I can imagine this was used in this codebase to enable smart contract bots to detect and sign challenges, which makes a lot of sense if you think about it.
